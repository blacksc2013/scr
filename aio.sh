...
sudo apt install -y apache2 php php-mysql libapache2-mod-php php-xml php-curl php-zip php-gd php-mbstring mysql-server wget unzip
...
echo "Enabling WordPress site and rewrite module..."
